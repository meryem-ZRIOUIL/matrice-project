...
with st.sidebar:
    st.markdown("""
        <div style="text-align: center; padding: 1rem 0;">
            ...
            <div style="font-size: 0.7rem; color: #64748b;">projet mathématiques</div>
        </div>
    """, unsafe_allow_html=True)
...
if page == "Accueil":
    ...
    st.markdown("<p style='color: #64748b; margin-bottom: 2rem;'>Exploration interactive des structures matricielles</p>", unsafe_allow_html=True)
    ...
    with col2:
        st.markdown("""
            <div class="metric">
                ...
                <div style="font-size: 0.7rem; color: #64748b;">calcul en temps reel</div>
            </div>
        """, unsafe_allow_html=True)
    ...
    with col1:
        st.markdown("""
            <div class="card" style="text-align: center;">
                ...
                <div style="font-size: 0.7rem; color: #64748b;">complexite O(n³)</div>
            </div>
        """, unsafe_allow_html=True)
    ...
    with col2:
        st.markdown("""
            <div class="card" style="text-align: center;">
                ...
                <div style="font-size: 0.7rem; color: #64748b;">gain memoire x100</div>
            </div>
        """, unsafe_allow_html=True)
    ...
    with col3:
        st.markdown("""
            <div class="card" style="text-align: center;">
                ...
                <div style="font-size: 0.7rem; color: #64748b;">convergence O(1/N)</div>
            </div>
        """, unsafe_allow_html=True)
    ...
    with col4:
        st.markdown("""
            <div class="card" style="text-align: center;">
                ...
                <div style="font-size: 0.7rem; color: #64748b;">valeur propre lambda</div>
            </div>
        """, unsafe_allow_html=True)
...
# ============================================================
    ...
    st.markdown("<p style='color: #64748b;'>Analyse du temps de calcul et de la precision numerique</p>", unsafe_allow_html=True)
    st.markdown("---")
...
# ============================================================
    ...
    st.markdown("<p style='color: #64748b;'>Optimisation mémoire, phénomène de fill-in et données manquantes</p>", unsafe_allow_html=True)
    st.markdown("---")
            ...
            with col2:
                st.markdown(f"""
                    <div class="metric">
                        ...
                        <div style="font-size:0.7rem;">densité {densite*100:.2f}%</div>
                    </div>
                """, unsafe_allow_html=True)
            ...
            with col3:
                st.markdown(f"""
                    <div class="metric">
                        ...
                        <div style="font-size:0.7rem;">{mem_sparse:.3f} Mo vs {mem_dense:.2f} Mo</div>
                    </div>
                """, unsafe_allow_html=True)
            ...
            with col1:
                st.markdown(f"""
                    <div class="metric">
                        ...
                        <div style="font-size:0.7rem;">densité {densite_avant:.1f}%</div>
                    </div>
                """, unsafe_allow_html=True)
            ...
            with col2:
                st.markdown(f"""
                    <div class="metric">
                        ...
                        <div style="font-size:0.7rem;">densité {densite_apres:.1f}%</div>
                    </div>
                """, unsafe_allow_html=True)
...
# ============================================================
    ...
    st.markdown("<p style='color: #64748b;'>Calcul element par element d'une matrice dependant du temps</p>", unsafe_allow_html=True)
    st.markdown("---")
...
# ============================================================
    ...
    st.markdown("<p style='color: #64748b;'>Simulation de l'évolution d'une population structurée par âge</p>", unsafe_allow_html=True)
    st.markdown("---")
    ...
    if st.button("🚀 Lancer la simulation", use_container_width=True):
        ...
        with col2:
            if lam > 1.01:
                ...
                st.markdown("""
                    <div class="metric">
                        <div class="metric-value">➡️ stable</div>
                        <div class="metric-label">λ = 1</div>
                    </div>
                """, unsafe_allow_html=True)
    ...
    if st.button("🎬 Afficher croissance / déclin / stable", key="show_cases"):
        ...
        fig2.update_layout(height=500, template="simple_white", showlegend=False)
